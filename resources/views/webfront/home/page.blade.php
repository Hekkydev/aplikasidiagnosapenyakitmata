...
<head>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li><a href="news-single.html">News Single Post</a></li>
									</ul>
								</li>
	...
	<!-- Slider Section Starts -->
		<section class="slider clearfix">
			...
			<!-- Slide #1 Starts -->
				<div data-src="{{ asset('frontsite')}}/images/slider/slider-img1.jpg">
			...
			<!-- Slide #1 Ends -->
			<!-- Slide #2 Starts -->
				<div data-src="{{ asset('frontsite')}}/images/slider/slider-img2.jpg">
			...
			<!-- Slide #2 Ends -->
            <!-- Slide #3 Starts -->
				<div data-src="{{ asset('frontsite')}}/images/slider/slider-img3.jpg">
					<div class="camera_caption fadeIn hidden-sm hidden-xs">
						<h2>Main Heading</h2>
						<h2><span>Some Caption</span> Here</h2>
						<p>
		...
		<!-- Welcome Section Starts -->
			<section class="welcome-area">
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						<img src="{{ asset('frontsite')}}/images/image1.jpg" alt="image" class="img-responsive img-style1">
					</div>
				</div>
			</section>
			...
			<!-- Medical Services List Starts -->
				<ul class="list-unstyled row text-center">
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/band-aid.png" alt="Band Aid">
						</div>
						<h5>First Aid</h5>
					...
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/tooth.png" alt="Dental Care">
						</div>
						<h5>Dental Care</h5>
						<p>Lorem Ipsum is simply dummy text ...</p>
					</li>
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/ambulance.png" alt="24x7 Ambulance">
						</div>
					...
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/nurse.png" alt="Qualified Doctors">
						</div>
					...
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/saline-bottle.png" alt="Medical Pharmacy">
						</div>
					...
					<li class="col-md-2 col-sm-4 col-xs-12">
						<div class="icon">
							<img src="{{ asset('frontsite')}}/images/icons/stethoscope.png" alt="Pulmonary">
						</div>
						<h5>Pulmonary</h5>
						<p>Lorem Ipsum is simply dummy text ...</p>
					</li>
									...
									<div class="row">
										...
										<!-- News Post Starts -->
											<div class="news-post-box">
												<img src="{{ asset('frontsite')}}/images/news/news-thumb-img1.jpg" alt="Blog Image" class="img-responsive img-center-sm img-center-xs">
												<div class="inner">
													<h5>
										...
										<!-- News Post Starts -->
											<div class="news-post-box">
												<img src="{{ asset('frontsite')}}/images/news/news-thumb-img2.jpg" alt="Blog Image" class="img-responsive img-center-sm img-center-xs">
												<div class="inner">
													<h5>
			...
			<div class="book-appointment-box">
				<div class="row">
					...
					<div class="col-md-4 col-xs-12 text-center-sm text-center-xs">
						<a href="{{ url('membership/register')}}" class="btn btn-main text-uppercase">Registrasi Pasien</a>
					</div>
					<div class="col-md-3 col-xs-12 hidden-sm hidden-xs">
						<div class="box-img">
							<img src="{{ asset('frontsite')}}/images/appointment-booking-img1.png" alt="" />
						</div>
					</div>
				</div>
			</div>
